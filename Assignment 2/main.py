...
def getHourlyData(locationForHourly):
    ...
    url = f"https://api.tomorrow.io/v4/timelines?location={loc[0]},{loc[1]}&fields={fieldsString}&timesteps=1h&units=imperial&timezone=America/Los_Angeles&apikey=XXTh8upbfipnNPN969YcW9xM6ABSBKcm"
    response = requests.get(url).json()
